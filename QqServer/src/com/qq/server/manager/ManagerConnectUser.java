...
import com.qq.common.LoginInfo;
...
public class ManagerConnectUser {
	...
	public static Vector<LoginInfo> getOnlineUser(){
		Vector<LoginInfo> infos = new Vector<LoginInfo>();
		Iterator it = ConectedClients.keySet().iterator();
		while(it.hasNext()){
			LoginInfo info = new LoginInfo();
			info.setUserName(it.next().toString());
			infos.add(info);
		}
		return infos;
	}
